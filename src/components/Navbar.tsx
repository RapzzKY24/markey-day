...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <nav className="w-full max-w-7xl rounded-4xl border border-neutral-100 bg-white/90 px-6 py-2 shadow-xl backdrop-blur-md transition-all duration-300 md:py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              >
                ...
                <span className="hidden md:block text-sm xl:text-lg text-white font-light whitespace-nowrap">
                  Keranjang
                </span>
                {totalItems > 0 && (
                  <span className="absolute -top-2 -right-2 bg-red-500 text-white text-[10px] md:text-xs font-bold w-5 h-5 md:w-6 md:h-6 rounded-full flex items-center justify-center border-2 border-white shadow-sm">
                    {totalItems}
                  </span>
                )}
              </motion.button>
            ...
            {isOpen && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full py-4 bg-primary text-white font-semibold rounded-xl shadow-lg flex items-center justify-center gap-2"
                >
