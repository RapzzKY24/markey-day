...
export const FloatingShapes = () => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      {/* Macaroni Float */}
      <div className="absolute top-[18%] left-[10%] animate-[float_6s_ease-in-out_infinite] opacity-90 drop-shadow-xl">
        <Macaroni className="rotate-[-15deg] scale-125" />
      </div>

      {/* Yakult Float */}
      <div className="absolute top-[80%] left-[15%] animate-[float_7s_ease-in-out_infinite_1s] opacity-90 drop-shadow-xl">
        <Yakult className="rotate-[10deg] scale-110" />
      </div>

      {/* Cheese Float */}
      <div className="absolute top-[20%] right-[15%] animate-[float_8s_ease-in-out_infinite_2s] opacity-90 drop-shadow-xl">
        <Cheese className="rotate-[25deg] scale-125" />
      </div>

      {/* Strawberry Ice Float */}
      <div className="absolute top-[70%] right-[10%] animate-[float_6.5s_ease-in-out_infinite_0.5s] opacity-90 drop-shadow-xl">
        <StrawberryIce className="rotate-[-10deg] scale-110" />
      </div>
    </div>
  );
};
